...
> **Примечание:** Документация находится в процессе рефакторинга (Фаза 5). Оригинальные файлы доступны в корне `docs/mts/` до завершения миграции.
...
- [Фаза 5](docs/PHASE5-PLAN.md) — Рефакторинг документации МТС (в процессе)

**Текущий статус:** Фаза 5 в процессе — Рефакторинг документации МТС.
- ✅ Этап 5.1: Подготовка структуры — завершён
- ✅ Этап 5.2: Рефакторинг раздела "Фундаментальные основы" — завершён
- ✅ Этап 5.3: Рефакторинг раздела "Система аксиом" — завершён
- ✅ Этап 5.4: Рефакторинг раздела "Нотации" — завершён
- ✅ Этап 5.5: Рефакторинг раздела "Логика и вычисления" — завершён
- ✅ Этап 5.6: Рефакторинг раздела "Архитектура прувера" — завершён
- ✅ Этап 5.7: Рефакторинг раздела "Философские аспекты" — завершён
- ⏳ Этап 5.8: Обновление README — ожидает
- ⏳ Этап 5.9: Проверка и финализация — ожидает
