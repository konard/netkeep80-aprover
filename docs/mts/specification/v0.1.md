...
AbitLit   ::= "'" { AbitChar } "'" ;  // последовательность абит-символов между апострофами (для абитовых ачисел)
AbitChar  ::= "[" | "0" | "1" | "]" ; // допустимые символы в абитовых ачислах

StringLit ::= '"' { Utf8Char } '"' ;  // строка символов между двойными кавычками (для строковых ачисел UTF-8)
...
4.7 Ввод UTF-8 символов через формальную нотацию
-----------------------------------------------------------------

// Одинарные кавычки '...' — для отдельных символов (четверичные абиты):
...
// Двойные кавычки "..." — для строковых ачисел (многосимвольные строки):
// Строка "abc" эквивалентна цепочке: (((∞ -> 'a') -> 'b') -> 'c')
// Примеры использования строковых литералов в формальной нотации:
// "связь" — строковое ачисло из 5 UTF-8 символов
// "01[]" — строковое представление четверичной последовательности
