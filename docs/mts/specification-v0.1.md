...
CharLit   ::= "'" Utf8Char "'" ;      // ровно один UTF-8 символ между апострофами (для четверичных абитов)

StringLit ::= '"' { Utf8Char } '"' ;  // строка символов между двойными кавычками (для строковых ачисел)
